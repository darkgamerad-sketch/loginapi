...
<head>
    ...
    <title>AdminLTE 3 | Nueva Tarea</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="#" class="nav-link">Nueva Tarea</a>
            </li>
        </ul>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('tareas.create') }}" class="nav-link active">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                               ...
                                               value="{{ old('nombre') }}" required maxlength="60">
                                        @error('nombre')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                                  ...
                                                  placeholder="Descripción opcional de la tarea">{{ old('descripcion') }}</textarea>
                                        @error('descripcion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('urgencia') is-invalid @enderror"
                                            ...
                                            <option value="0" {{ old('urgencia') == '0' ? 'selected' : '' }}>
                                                🟢 No es urgente
                                            </option>
                                            <option value="1" {{ old('urgencia') == '1' ? 'selected' : '' }}>
                                                🟡 Urgencia normal
                                            </option>
                                            <option value="2" {{ old('urgencia') == '2' ? 'selected' : '' }}>
                                                🔴 Muy urgente
                                            </option>
                                        </select>
                                        @error('urgencia')
                    ...
                    <div class="col-md-4">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>La descripción es opcional.</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    document.getElementById('fecha_limite').min = new Date().toISOString().slice(0, 16);
</script>
</body>
</html>
